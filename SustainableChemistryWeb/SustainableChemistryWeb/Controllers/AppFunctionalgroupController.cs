...
namespace SustainableChemistryWeb.Controllers
{
    ...
    [ApiController]
    public class FunctionalGroupsController : ControllerBase
    {
        ...
        // GET: api/functionalgroups/bySmiles?smiles=O=P(OC)(OC)C
        [HttpGet("bySmiles")]
        ...
        // GET: api/functionalgroups/byMolecule?smiles=O=P(OC)(OC)C
        [HttpGet("byMolecule")]
