...
namespace SustainableChemistry
{
    public partial class ReactionEditor : Form
    {
        ...
        System.Data.DataTable m_FunctionalGroups;
        ...
        {
            //ChemInfo.NamedReaction r = m_FunctionalGroup.app_namedreaction[ReactionNameComboBox.SelectedItem.ToString()];
        ...
        private void productComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //foreach (ChemInfo.NamedReaction r in m_FunctionalGroup.app_namedreaction)
            //{
        ...
        public string SelectedNamedReaction
        {
            get
            {
                if (this.m_FunctionalGroup == string.Empty) return string.Empty;
                return this.ReactionNameComboBox.Text;
            }
        }
