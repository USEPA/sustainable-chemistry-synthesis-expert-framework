...
namespace SustainableChemistry
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            foreach (System.Data.DataRow row in app_functionalgroup.Rows)
            {
                row["LowerName"] = row["Name"].ToString().ToLower();
            }
            foreach (System.Data.DataRow row in app_namedreaction.Rows)
            {
                row["LowerName"] = row["Name"].ToString().ToLower();
            }
